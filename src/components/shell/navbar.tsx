...
import { SITE_AUDIENCE } from "@/lib/site-meta";
  ...
  return (
    <header className="sticky top-0 z-30 hidden border-b border-white/8 bg-[rgba(7,10,21,0.82)] px-6 py-4 backdrop-blur md:block">
      <div className="flex items-center justify-between gap-4">
        {/*
          A real search now. This was an Input with no name and no form, so
          typing in it did nothing at all. Discover already reads ?q=.
        */}
        <form action="/discover" method="get" className="w-full max-w-md">
          <Input
            type="search"
            name="q"
            placeholder="Search builders by name, skill, or country..."
